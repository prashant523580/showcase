...
function ActiveLink({ children, href,handleClick } : any) {
...
export default function Example() {
  ...
  return (
    <div className="bg-white">
      <header className="absolute shadow-md bg-white inset-x-0 top-0 z-50">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <Link href="tel:+9779816514719" className="text-sm font-semibold leading-6 text-gray-900">
              Call <span aria-hidden="true">&rarr;</span>
            </Link>
          </div>
        </nav>
