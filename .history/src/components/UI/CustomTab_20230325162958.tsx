    ...
    <Box sx={{  }}>
      <Box sx={{ display:"flex",justifyContent:"center" }}>
        <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
          <Tab sx={{color:"red", fontWeight:"bold"}}  label="All" {...a11yProps(0)} />
          <Tab sx={{color:"red", fontWeight:"bold"}}  label="Arts" {...a11yProps(1)} />
          <Tab sx={{color:"red", fontWeight:"bold"}}  label="illustrate" {...a11yProps(2)} />
        </Tabs>
      </Box>
